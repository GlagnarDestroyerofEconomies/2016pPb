...
while IFS='' read -r line || [[ -n "$line" ]]; do
  ...
  echo "config.General.requestName = 'pPb2016_PromptReco_MinBias2_${runNumber}_withCent'" >> crabsubmitcfg.py
...
#  echo "lumi_mask='Cert_262548-263757_PromptReco_HICollisions15_JSON.txt'" >> crabsubmitcfg.py
  ...
  echo "config.Site.storageSite = 'T3_US_UMD'" >> crabsubmitcfg.py
